...
public class ObjectLineMapperTest
{
    ...
    public void mapTest()
    {
        ...
        Assert.assertNotNull("Null field : innerObject.innerName", mappedObject.getInnerObject().getInnerName());
        Assert.assertNotNull("Null field : innerObject.innerAge", mappedObject.getInnerObject().getInnerAge());
    }
