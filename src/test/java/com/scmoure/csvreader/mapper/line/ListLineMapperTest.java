...
public class ListLineMapperTest
{
    ...
    public void mapObjectElementListTest()
    {
        ...
        ListLineMapper mapper = new ListLineMapper.ListLineMapperBuilder(0, 5, 2, InnerTestClass.class).build();
        ...
        Assert.assertEquals("Not expected age value for object 1", Long.valueOf(10), result.get(0).getInnerAge());
        Assert.assertEquals("Not expected name value for object 2", "object 2", result.get(1).getInnerName());
        Assert.assertEquals("Not expected age value for object 2", Long.valueOf(20), result.get(1).getInnerAge());
        Assert.assertEquals("Not expected name value for object 3", "object 3", result.get(2).getInnerName());
        Assert.assertEquals("Not expected age value for object 3", Long.valueOf(30), result.get(2).getInnerAge());
    }
}
